...
// Mock for AnimatedBeamMultipleOutputDemo
const AnimatedBeamMultipleOutputDemo = ({ className }: { className?: string }) => (
  <div className={cn("bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center text-sm text-neutral-500 rounded-lg", className)}>
    AnimatedBeam Demo
  </div>
);

// Mock for AnimatedListDemo
