...
export default function FeatureSection() {
  ...
  return (
    <section className="relative max-w-100% mx-auto my-32 pl-10 flex items-center justify-between h-[40rem] dark:border-gray-700 bg-white dark:bg-white rounded-3xl">
